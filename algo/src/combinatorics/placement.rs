...
/// Размещения используются в задачах, где важен порядок выбранных элементов,
/// но не важен порядок невыбранных, например, при формировании команд,
/// назначении ролей, или в комбинаторных расчетах для упорядоченных выборок.
///
/// # Аргументы
